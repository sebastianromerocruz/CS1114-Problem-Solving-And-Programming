...
if condition_one:
    print("The ratio is between 0 and", random_number, "so the expression evaluates to true.")
elif condition_two and condition_three:
    print("Both numbers are within 0 and", random_number, "so the expression evaluates to true.")
else:
